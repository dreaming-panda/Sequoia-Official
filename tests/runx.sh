...
CUDA_VISIBLE_DEVICES=2 python testbed_greedy.py --model  princeton-nlp/Sheared-LLaMA-1.3B    --target lmsys/vicuna-33b-v1.3  --T 0.6 --P 1.0  --start 0 --end 200 --M 384 --growmap ../L40_growmaps/4-chain.pt  --Mode greedy --dataset openwebtext >> x2.log
CUDA_VISIBLE_DEVICES=2 python testbed.py --model  princeton-nlp/Sheared-LLaMA-1.3B    --target lmsys/vicuna-33b-v1.3  --T 0.6 --P 1.0  --start 0 --end 200 --M 384 --growmap ../L40_growmaps/4-chain.pt  --Mode greedy --dataset openwebtext >> x2.log

CUDA_VISIBLE_DEVICES=2 python testbed_greedy.py --model  princeton-nlp/Sheared-LLaMA-1.3B    --target lmsys/vicuna-33b-v1.3  --T 0.6 --P 1.0  --start 0 --end 200 --M 384 --growmap ../L40_growmaps/4-chain.pt  --Mode greedy --dataset cnn >> x2.log
CUDA_VISIBLE_DEVICES=2 python testbed.py --model  princeton-nlp/Sheared-LLaMA-1.3B    --target lmsys/vicuna-33b-v1.3  --T 0.6 --P 1.0  --start 0 --end 200 --M 384 --growmap ../L40_growmaps/4-chain.pt  --Mode greedy --dataset cnn >> x2.log
